...
<div class="page page-center">
      <div class="container container-tight py-4">
          ...
          <div class="card-body">
            ...
            <form action="./" method="get" autocomplete="off" novalidate="">
              <div class="mb-3">
                ...
                <input type="email" class="form-control" placeholder="seu@email.com" autocomplete="off">
              </div>
              <div class="mb-2">
                ...
                <div class="input-group input-group-flat">
                  ...
                  <span class="input-group-text">
                    <a href="#" class="link-secondary" data-bs-toggle="tooltip" aria-label="Mostrar senha" data-bs-original-title="Mostrar senha"><!-- Download SVG icon from http://tabler-icons.io/i/eye -->
        ...
        <div class="text-center text-muted mt-3">
          Ainda não tem conta? <a href="./sign-up" tabindex="-1">Inscrever-se</a>
        </div>
      </div>
    </div>
